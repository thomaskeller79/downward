...
CONFIGS = [
    (26, [
        "--evaluator",
        "hlm=lmcount(lm_acyclic(lm_rhw(reasonable_orders=true)),transform=adapt_costs(one))",
        "--evaluator",
    ...
    (25, [
        "--landmarks",
        "lmg=lm_acyclic(lm_rhw(only_causal_landmarks=false,disjunctive_landmarks=true,conjunctive_landmarks=true,no_orders=true))",
        "--evaluator",
    ...
    (29, [
        "--landmarks",
        "lmg=lm_acyclic(lm_rhw(only_causal_landmarks=false,disjunctive_landmarks=true,conjunctive_landmarks=true,no_orders=false))",
        "--evaluator",
    ...
    (29, [
        "--landmarks",
        "lmg=lm_acyclic(lm_rhw(reasonable_orders=false,only_causal_landmarks=false,disjunctive_landmarks=false,conjunctive_landmarks=true,no_orders=false))",
        "--evaluator",
    ...
    (24, [
        "--landmarks",
        "lmg=lm_acyclic(lm_rhw(reasonable_orders=true,only_causal_landmarks=true,disjunctive_landmarks=true,conjunctive_landmarks=true,no_orders=false))",
        "--evaluator",
        "hblind=blind()",
        "--evaluator",
        "hadd=add()",
    ...
    (53, [
        "--landmarks",
        "lmg=lm_acyclic(lm_hm(only_causal_landmarks=false,disjunctive_landmarks=true,conjunctive_landmarks=false,no_orders=true,m=1))",
        "--evaluator",
    ...
    (54, [
        "--landmarks",
        "lmg=lm_acyclic(lm_hm(only_causal_landmarks=false,disjunctive_landmarks=true,conjunctive_landmarks=true,no_orders=false,m=1))",
        "--evaluator",
        "hlm=lmcount(lmg,admissible=true)",
        "--evaluator",
        "hff=ff()",
    ...
    (30, [
        "--landmarks",
        "lmg=lm_acyclic(lm_exhaust(reasonable_orders=false,only_causal_landmarks=false,disjunctive_landmarks=true,conjunctive_landmarks=true,no_orders=false))",
        "--evaluator",
        "hff=ff(transform=adapt_costs(plusone))",
        "--evaluator",
        "hhmax=hmax()",
    ...
    (19, [
        "--landmarks",
        "lmg=lm_acyclic(lm_merged([lm_rhw(),lm_hm(m=1)],only_causal_landmarks=false,disjunctive_landmarks=false,conjunctive_landmarks=true,no_orders=false))",
        "--evaluator",
        "hff=ff()",
        "--evaluator",
        "hlm=lmcount(lmg,admissible=true)",
    ...
    (24, [
        "--landmarks",
        "lmg=lm_acyclic(lm_zg(reasonable_orders=false,only_causal_landmarks=false,disjunctive_landmarks=true,conjunctive_landmarks=true,no_orders=true))",
        "--evaluator",
    ...
    (81, [
        "--landmarks",
        "lmg=lm_acyclic(lm_hm(only_causal_landmarks=false,disjunctive_landmarks=true,conjunctive_landmarks=true,no_orders=true,m=1))",
        "--evaluator",
        "hlm=lmcount(lmg,admissible=true)",
        "--search",
