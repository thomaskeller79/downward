...
CONFIGS = [
    ...
    (114, ["--evaluator", "hadd=add(transform=H_COST_TRANSFORM)",
         "--evaluator",
         "hlm=lmcount(lm_acyclic(lm_rhw(reasonable_orders=true)),transform=adapt_costs(plusone))", "--search",
...
FINAL_CONFIG = [
    ...
    "--evaluator",
    "hlm=lmcount(lm_acyclic(lm_rhw(reasonable_orders=true)),transform=adapt_costs(plusone))",
    "--search",
